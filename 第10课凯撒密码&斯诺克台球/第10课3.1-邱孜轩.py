...
for i in range(24):#画白球并让白球移动
    bq(-260+(18-(i)**2/308)*i,-5+(8-(i)**2/693)*i)#实现白球减速
    sleep(0.02+i/700)
    t1.clear()
for a in range(1,12):#画白球并让白球移动
    bq(-260+(18-(i+a)**2/308)*(i+a),-5+(8-(i+a)**2/693)*(i-a))#实现白球减速
    sleep(0.05+a/1000)
    t1.clear()
bq(-260+(18-(i+a)**2/308)*(i+a),-5+(8-(i+a)**2/693)*(i-a))
